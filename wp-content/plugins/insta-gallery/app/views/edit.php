...
<form method="post" id="ig-form-update" action="<?php if(empty($InstaGalleryItem))  echo INSGALLERY_URL_ADMIN_PAGE; ?>">
    ...
    ?></span> ) </span></td>
			...
			<tr>
				...
				<td><input name="insta_popup-caption" type="checkbox" value="1" <?php echo (isset($InstaGalleryItem) && empty($InstaGalleryItem['insta_popup-caption'])) ? '' : 'checked'; ?> />
					<span class="description"><?php _e('Display caption/tags below images when popup.','insta-gallery'); ?></span></td>
			</tr>
			<tr>
