...
/*Template name: Acceuil*/?>
    ...
    <div class="banner relative">
        ...
        <div class="container absolute text_header text-center">
            ...
            <a href="<?php echo esc_url( get_permalink(38) ); ?>" class="btn btnType">Notre concept</a>
        </div>
                ...
                <?php 
                    ...
                    <div class="col-sm-6">
                        <div class="relative list_maisonHome">
                            <a href="http://www.devmc.site/maisons/ialy/ <?php //the_permalink();?>">
